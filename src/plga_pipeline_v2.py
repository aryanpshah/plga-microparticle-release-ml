...
class PLGAPrecisionPipeline:
    ...
    def train_and_validate(self) -> None:
        """10-fold group CV, mean imputation per fold, stacking; binary burst classification."""
        ...
        for target in self.targets:
            ...
            all_groups = groups_curr[np.array(all_indices)]
        ...
        # Create Classes: Low (<=0.20), High (>0.20)
